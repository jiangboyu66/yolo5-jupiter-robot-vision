...
PRICE_MAP = {
    ...
    # "Kurkure": "RM 2.50",
    # "Lays Masala": "RM 4.50",
    # "Lays Mexican": "RM 4.50",
    # "Lifebuoy Soap": "RM 2.20",
    # "Sunsilk Shampoo": "RM 9.90",
    # "Vaseline Lotion": "RM 15.90"
}
...
class Detector:
    ...
    def __init__(
        ...
        weights='/home/mustar/yolov5/final_version.pt',  # <--- your trained model ROOT / 'best_grocery.pt' '/home/mustar/yolov5/final_version.pt'
        data=ROOT / 'data/my_dataset.yaml',  # optional ROOT / 'data/grocery2.yaml'
    ...
    def detect(self, img0):
        ...
        if len(det):
            ...
            for *xyxy, conf, cls in reversed(det):
                ...
                result.append(Result(xyxy, class_name, conf))

                if self.view_img:
                    price = PRICE_MAP.get(class_name, "RM ?")
                    ...
                    if self.hide_labels:
                        ...
                        if self.hide_conf:
                            ...
                            label = f"{class_name} | {price} | {conf:.2f}"
